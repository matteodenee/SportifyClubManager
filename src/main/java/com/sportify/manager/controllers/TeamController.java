...
public class TeamController {
    ...
    public boolean handleCreateTeam(String nom, String categorie, int clubId, Integer coachId, Integer typeSportId) {
        try {
            // Validation basique de l'interface utilisateur
            if (clubId <= 0) {
