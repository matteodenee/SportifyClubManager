...
public class Team {
    ...
    private int clubId;
    private Integer coachId; // Peut être null
    private Integer typeSportId; // Peut être null
    
    // Listes chargées à la demande (Lazy loading) ou immédiatement selon besoin
    private List<User> players;

    public Team(int id, String nom, String categorie, int clubId, Integer coachId, Integer typeSportId) {
        this.id = id;
        this.nom = nom;
    ...
    public Team(String nom, String categorie, int clubId, Integer coachId, Integer typeSportId) {
